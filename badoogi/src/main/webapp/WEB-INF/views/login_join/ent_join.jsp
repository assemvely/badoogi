...
<form id="frm" action="/user/ent_licensee" method="POST" enctype="multipart/form-data">
...
<input type="text" size="55" placeholder="닉네임입력" id="nickInput" name="nickname" style="font-size:19pt; border-radius:10px;margin-bottom:30px;">
<h5 id="nickconform"></h5>
<input type="text" size="55" placeholder="badugi@naver.com" id="emailInput"name="email" style="font-size:19pt;border-radius:10px;margin-bottom:30px;">
...
<!-- 밑에는 첨부파일, 디비없음, 이미지 구현아직 -->
<h3>첨부파일</h3>
<input type=file id="input_img2" name="imageFile2">
<div class="img_wrap">
	<img id="img2">
</div>
<input type="hidden" name="savePath2" value="C://badoogi//LICENSEIMG/">
<input type="hidden" name="usercode" value="ent">
<input type="hidden" name="certify" value="Y">
<input type="hidden" name="admission" value="N">

<input type="hidden" name="licensenumber" value="${licesenumber}">
<br/>
